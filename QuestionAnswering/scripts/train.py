...
def train():
    '''
    Pipeline for training LLaMA model
    '''
    ...
    for epoch in range(n_epochs):
        ...
        if valid_loss < best_valid_loss:
            ...
            # save model weight
            torch.save(model.model.embed_tokens.state_dict(), "embed.pt")
            torch.save(model.model.layers[num_decoder_layers:].state_dict(), "layers.pt")
            torch.save(model.model.norm.state_dict(), "rms_norm.pt")
